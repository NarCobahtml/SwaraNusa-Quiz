...
class TebakBenar1 extends StatefulWidget {
  const TebakBenar1({super.key});

  @override
  State<TebakBenar1> createState() => _TebakBenar1State();
}

class _TebakBenar1State extends State<TebakBenar1> {
  @override
  void initState() {
    super.initState();
