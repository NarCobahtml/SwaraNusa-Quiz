...
class KuisBenar10 extends StatefulWidget {
  const KuisBenar10({super.key});

  @override
  State<KuisBenar10> createState() => _KuisBenar10State();
}

class _KuisBenar10State extends State<KuisBenar10> {
  @override
  void initState() {
    super.initState();
          ...
          PageRouteBuilder(
            pageBuilder: (context, animation, secondaryAnimation) =>
                const QuizResultScreen(
                  correctAnswers: 8, // Dummy values for now
                  wrongAnswers: 2,
                  totalQuestions: 10,
                ),
