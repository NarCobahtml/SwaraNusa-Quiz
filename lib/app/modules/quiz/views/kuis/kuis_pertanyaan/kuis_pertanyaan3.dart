...
import '../kuis_benar/kuis_benar3.dart';
import '../kuis_salah/kuis_salah3.dart';

class KuisPertanyaan3 extends StatefulWidget {
  const KuisPertanyaan3({super.key});

  @override
  State<KuisPertanyaan3> createState() => _KuisPertanyaan3State();
}

class _KuisPertanyaan3State extends State<KuisPertanyaan3> {
  ...
  Widget _buildAnswerOptions() {
    final options = ['Tifa', 'Kolintang', 'Gamelan', 'Angklung'];
