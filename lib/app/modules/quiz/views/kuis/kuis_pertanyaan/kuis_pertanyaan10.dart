...
import '../kuis_benar/kuis_benar10.dart';
import '../kuis_salah/kuis_salah10.dart';

class KuisPertanyaan10 extends StatefulWidget {
  const KuisPertanyaan10({super.key});

  @override
  State<KuisPertanyaan10> createState() => _KuisPertanyaan10State();
}

class _KuisPertanyaan10State extends State<KuisPertanyaan10> {
  ...
  Widget _buildAnswerOptions() {
    final options = ['Gendang', 'Tifa', 'Kecapi', 'Rebab'];
