...
class SejarahSalah1 extends StatefulWidget {
  const SejarahSalah1({super.key});

  @override
  State<SejarahSalah1> createState() => _SejarahSalah1State();
}

class _SejarahSalah1State extends State<SejarahSalah1> {
  @override
  void initState() {
    super.initState();
